    ...
    <el-dialog title="数据报表" :visible.sync="dialogFormVisible" width="25%">
      <el-form :model="form" label-width="100px" size="small">
        <el-form-item label="用电部门id">
          <el-input v-model="form.departmentId" autocomplete="off" placeholder="必填项"></el-input>
        </el-form-item>
        ...
        <el-form-item label="计量(kWh)">
          <el-input v-model="form.calculation" autocomplete="off" placeholder="必填项"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      if (tmp_form === "{}" || this.form.departmentId === "" || this.form.departmentId === null || this.form.departmentId === undefined) {
